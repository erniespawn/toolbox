...
class DataSM(Command):
    ...
    params = {
        ...
        'user_message_reference': Param(type=str, max=13),
...
class DataSMResp(Command):
    ...
    def __init__(self, command, **kwargs):
        ...
        self._set_vars(**(dict.fromkeys(self.params)))
        # print ("hhhhhh {}".format(self._set_vars(**(dict.fromkeys(self.params)))))
...
class QuerySMResp(Command):
    ...
    def __init__(self, command, **kwargs):
        ...
        self._set_vars(**(dict.fromkeys(self.params)))
        # print ("gggggg {}".format(self._set_vars(**(dict.fromkeys(self.params)))))
